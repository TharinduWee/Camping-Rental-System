...
if (isset($_POST['form1'])) {
    ...
    if (empty($_POST['location_link'])) {
        $valid = 0;
        $error_message .= 'Location Link can not be empty<br>';
    }
    ...
    if ($valid == 1) {
        ...
        $statement = $pdo->prepare("INSERT INTO tbl_service (title, content, photo, location_link) VALUES (?, ?, ?, ?)");
        $statement->execute(array($_POST['title'], $_POST['content'], $final_name, $_POST['location_link']));
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" autocomplete="off" class="form-control" name="location_link" value="<?php if (isset($_POST['location_link'])) {
                                                                                                                            echo $_POST['location_link'];
                                                                                                                        } ?>">
                            </div>
                        </div>
                        <div class="form-group">
